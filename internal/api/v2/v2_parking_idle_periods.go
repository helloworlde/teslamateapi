...
func (h V2Handlers) IdlePeriods(c *gin.Context) {
	...
	if h.idlePeriodsBuilder == nil {
		apicommon.V2Error(c, http.StatusInternalServerError, "INTERNAL_ERROR", "V2 idle periods service is not configured.", nil)
		return
	}
	...
	if err != nil {
		...
		default:
			apicommon.V2Error(c, http.StatusInternalServerError, "INTERNAL_ERROR", "Unable to build V2 idle periods.", err.Error())
		}
		return
	}
