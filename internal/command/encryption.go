...
// CarRegionAPI values returned by GetCarRegionAPI.
const (
...
// GetCarRegionAPI inspects the iss claim of a Tesla access token JWT and
// returns ChinaAPI for issuers ending in `.cn`, otherwise GlobalAPI.
