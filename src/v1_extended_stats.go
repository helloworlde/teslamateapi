...
// TeslaMateAPICarsStatsV2 returns period KPIs in a clean, non-redundant structure.
// Replaces the old /summary, /statistics, and /dashboard endpoints.
//
// Query params:
//   ?period=week|month|year   (default: month)
//   ?startDate=YYYY-MM-DD     (use with endDate for custom range)
//   ?endDate=YYYY-MM-DD
...
func buildStats(ctx *apiCarContext, dr v1DateRange) (map[string]any, error) {
	...
	// Phase B — regen depends on drive summary from Phase A.
